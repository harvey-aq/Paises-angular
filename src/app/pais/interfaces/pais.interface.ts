...
export class Convert {
    public static toRESTContriesResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTContriesResponse")));
    }

    public static rESTContriesResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTContriesResponse"))), null, 2);
    }
}
